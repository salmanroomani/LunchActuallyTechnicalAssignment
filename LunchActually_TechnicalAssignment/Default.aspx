<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LunchActually_TechnicalAssignment.Default" %>
    ...
    <header class="site-header js-site-header">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div class="col-6 col-lg-4 site-logo" data-aos="fade"><a href="Default.aspx">Lunch Actually</a></div>
          <div class="col-6 col-lg-8">


            <div class="site-menu-toggle js-site-menu-toggle"  data-aos="fade">
              <a style="font-weight:bold" href="Admin/Login.aspx">LOGIN</a>
            </div>
            <!-- END menu-toggle -->
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/img_3.jpg" alt="Single BEd" class="img-fluid mb-3">
              </figure>
          ...
          <div class="col-md-6 col-lg-6" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="images/img_1.jpg" alt="Double Bed" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
